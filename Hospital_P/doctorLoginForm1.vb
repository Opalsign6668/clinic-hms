...
Public Class doctorLoginForm1
    ...
    Private Sub OK_Click(sender As Object, e As EventArgs) Handles OK.Click
        Try
            ...
            cmd.Parameters.AddWithValue("@Maa020", txt_Password.Text)
            cmd.ExecuteNonQuery()
        ...
        If dt.Rows.Count > 0 Then
            ...
            If txt_Username.Text = "user" And txt_Password.Text = "Maa020" Then
                ...
                If Exist = DialogResult.Yes Then
                    ...
                    Dim doctor As DoctorForm
                    doctor = New DoctorForm
                    doctor.Show()


                    Dim doct As doctorLoginForm1
                    doct = New doctorLoginForm1
                    doct.Close()
                    Me.Close()
                Else
                    txt_Password.Text = ""
    ...
    Private Sub doctorLoginForm1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Size = New System.Drawing.Size(579, 300)
        Me.CenterToScreen()
    End Sub
End Class
