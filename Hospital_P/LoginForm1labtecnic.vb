...
Public Class labtechniLoginForm1
        ...
        If dt.Rows.Count > 0 Then
            ...
            If txt_Username.Text = "user" And txt_Password.Text = "hospital" Then
                ...
                If Exist = DialogResult.Yes Then
                    ...
                    Dim labtechni As New LabTech
                    labtechni = New LabTech
                    labtechni.Show()


                    Dim labtc As labtechniLoginForm1
                    labtc = New labtechniLoginForm1
                    labtc.Close()
                    Me.Close()
                Else
                    txt_Password.Text = ""
    ...
    Private Sub labtechniLoginForm1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
